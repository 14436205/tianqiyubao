...
//	ToolTwo toolTwo;
	...
	//HashMap<String, Object> myApplication.cityData3;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_city3, container, false);
...
//			weatherMainActivityFragment1.getWeather(2);
		}				
		return view;
	}
...
//			weatherMainActivityFragment1.getWeather(2);
	...
	private void getWeatherInfoFoforFragment() {
		// TODO Auto-generated method stub
		tv_fragment_air_quality1_2.setText(myApplication.cityData3.get("quality").toString());	
		tv_fragment_air_pm1_2.setText(myApplication.cityData3.get("pm252").toString()+"μg/m³");	
		tv_fragment_curPm1_2.setText(myApplication.cityData3.get("curPm").toString()+"μg/m³");	

		tv_out_time1.setText(myApplication.cityData3.get("time").toString());	

		tv_fragment_wind_speed1_2.setText(myApplication.cityData3.get("windPower").toString()+"，"+ myApplication.cityData3.get("winDirect").toString()+"，风速"+myApplication.cityData3.get("windSpeed").toString());//风力指数3个信息拼接

		weather_fragment_text.setText(myApplication.cityData3.get("curWeatherText").toString());

		tv_fragment_temperature.setText(myApplication.cityData3.get("temperature").toString());


		ArrayList<HashMap<String, Object>> fragmentArrayList = (ArrayList<HashMap<String, Object>>) myApplication.cityData3.get("weather");
	...
	public void onClick(View v) {
		...
		case R.id.tv_delete1:
			...
			myApplication.city3 = "错误";
			SharedPreferencesUtils.inputValue(mContext, "city3", "错误");
			relativeLayout1.setVisibility(relativeLayout1.GONE);//撤销
			textViewAdd1.setVisibility(tv_delete1.VISIBLE);//可见
			weatherMainActivityFragment1.allInfoToBeFullOrNull();
		...
		case R.id.tv_change1:
			...
			weatherMainActivityFragment1.startTuChangeCity(3);
