...
//			myApplication.cityDataArray1 = (ArrayList<HashMap<String, Object>>) myApplication.cityData1.get("weather");
		...
		//	weatherMainActivityFragment1.getWeather(0);
		}			
		return view;
	}
...
//			myApplication.cityDataArray1 = (ArrayList<HashMap<String, Object>>) myApplication.cityData1.get("weather");
	...
	private void getWeatherInfoFoforFragment() {
		// TODO Auto-generated method stub
		tv_fragment_air_quality1_2.setText(myApplication.cityData1.get("quality").toString());	
		tv_fragment_air_pm1_2.setText(myApplication.cityData1.get("pm252").toString()+"μg/m³");	
		tv_fragment_curPm1_2.setText(myApplication.cityData1.get("curPm").toString()+"μg/m³");	

		tv_out_time1.setText(myApplication.cityData1.get("time").toString());	

		tv_fragment_wind_speed1_2.setText(myApplication.cityData1.get("windPower").toString()+"，"+ myApplication.cityData1.get("winDirect").toString()+"，风速"+myApplication.cityData1.get("windSpeed").toString());//风力指数3个信息拼接

		weather_fragment_text.setText(myApplication.cityData1.get("curWeatherText").toString());

		tv_fragment_temperature.setText(myApplication.cityData1.get("temperature").toString());


		ArrayList<HashMap<String, Object>> fragmentArrayList = (ArrayList<HashMap<String, Object>>) myApplication.cityData1.get("weather");
	...
	public void onClick(View v) {
		...
		case R.id.tv_delete1:
			...
			myApplication.city1 = "错误";
			SharedPreferencesUtils.inputValue(mContext, "city1", "错误");
			relativeLayout1.setVisibility(relativeLayout1.GONE);//撤销
			textViewAdd1.setVisibility(tv_delete1.VISIBLE);//可见
			weatherMainActivityFragment1.allInfoToBeFullOrNull();
		...
		case R.id.tv_change1:
			...
			weatherMainActivityFragment1.startTuChangeCity(1);
