...
//	ToolTwo toolTwo;
	...
	//HashMap<String, Object> myApplication.cityData2;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.fragment_city2, container, false);
...
//			myApplication.cityDataArray2 = (ArrayList<HashMap<String, Object>>) myApplication.cityData2.get("weather");
		...
		//	weatherMainActivityFragment1.getWeather(1);
		}				
		return view;
	}
...
//			myApplication.cityDataArray2 = (ArrayList<HashMap<String, Object>>) myApplication.cityData2.get("weather");
	...
	private void getWeatherInfoFoforFragment() {
		// TODO Auto-generated method stub
		tv_fragment_air_quality1_2.setText(myApplication.cityData2.get("quality").toString());	
		tv_fragment_air_pm1_2.setText(myApplication.cityData2.get("pm252").toString()+"μg/m³");	
		tv_fragment_curPm1_2.setText(myApplication.cityData2.get("curPm").toString()+"μg/m³");	

		tv_out_time1.setText(myApplication.cityData2.get("time").toString());	

		tv_fragment_wind_speed1_2.setText(myApplication.cityData2.get("windPower").toString()+"，"+ myApplication.cityData2.get("winDirect").toString()+"，风速"+myApplication.cityData2.get("windSpeed").toString());//风力指数3个信息拼接

		weather_fragment_text.setText(myApplication.cityData2.get("curWeatherText").toString());

		tv_fragment_temperature.setText(myApplication.cityData2.get("temperature").toString());


		ArrayList<HashMap<String, Object>> fragmentArrayList = (ArrayList<HashMap<String, Object>>) myApplication.cityData2.get("weather");
	...
	public void onClick(View v) {
		...
		case R.id.tv_delete1:
			...
			myApplication.city2 = "错误";
			SharedPreferencesUtils.inputValue(mContext, "city2", "错误");
			relativeLayout1.setVisibility(relativeLayout1.GONE);//撤销
			textViewAdd1.setVisibility(tv_delete1.VISIBLE);//可见
			weatherMainActivityFragment1.allInfoToBeFullOrNull();
		...
		case R.id.tv_change1:
			...
			weatherMainActivityFragment1.startTuChangeCity(2);
